...
const navigation: NavItem[] = [
  { name: 'Home', href: '/user/home/index', icon: Home },
  ...
  <>
    ...
    >
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        // ✅ Khusus NIPL → aktif kalau di /user/nipl ATAU /user/nipl/create
        if (item.name === "NIPL") {
          isActive =
            pathname.startsWith("/user/nipl/index") || pathname === "/user/nipl/create";
        } else {
          // ✅ Menu lain → harus match persis
