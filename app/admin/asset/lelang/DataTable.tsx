...
export default function DataTable({ initialData }: DataTableProps) {
  ...
  const [selectedStatus, setSelectedStatus] = useState<string | "all">("all"); // 🔹 tambahkan ini
            ...
            <div className="flex gap-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm rounded-md font-medium flex items-center gap-1.5 transition-colors ${sortConfig?.field === 'created_at' && sortConfig.direction === 'desc'
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm rounded-md font-medium flex items-center gap-1.5 transition-colors ${sortConfig?.field === 'created_at' && sortConfig.direction === 'asc'
                    ? 'bg-blue-600 text-white shadow-md hover:bg-blue-700'
                    : 'bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400'
                    }`}
